...
const Division = ({
    ...
    const handleDivisionChange = (e, leagueI, divisionI) => {
        let temp = { ...newList };
        temp.leagues[leagueI].divisions[divisionI][e.target.name] =
            e.target.value;
        setNewList(temp);
    };
    ...
    return (
        <div className={props.className}>
            ...
            <input
                ...
                name="divisionName"
                onChange={(e) =>
                    handleDivisionChange(e, leagueIndex, divisionIndex)
                }
            ...
            <button onClick={() => addDivision(leagueIndex)}>
                Add Division
            </button>
            <button onClick={() => removeDivision(leagueIndex, divisionIndex)}>
                Remove
            </button>
        </div>
    );
